...
An open-source advocate who helps developers to solve their problems by sharing useful projects on Github.
...
\Item
Designing and Building a micro-service architecture responsive Flutter gallery application uses in any platform.
This application supports \textbf{null-safety}, \textbf{multi-languages}, \textbf{new navigation}, \textbf{multi-themes}, and \textbf{multi-devices adaptive size}. And the \textbf{micro-service architecture} is explained on \textbf{Medium}.
